...
public interface GoldenGateWebServiceConstants {
	...
	/** the XML node type for a node holding a specific callback in the status of a web service invocation */
	public static final String CALLBACK_NODE_TYPE = "callback";
	
	/** the XML attribute holding the document/invocation ID in the status of a web service invocation */
	public static final String DOCUMENT_ID_ATTRIBUTE = "docId";
	
	/** the XML attribute holding the state in the status of a web service invocation, its value is either of 'processing' or 'finished' */
	public static final String STATE_ATTRIBUTE = "state";
	
	/** the value to the state type attribute indicating that a web service invocation is still processing */
	public static final String PROCESSING_STATE = "processing";
	
	/** the value to the state type attribute indicating that a web service invocation is finished */
	public static final String FINISHED_STATE = "finished";
	
	/** the XML attribute holding the type of a callback in the status of a web service invocation */
	public static final String CALLBACK_TYPE_ATTRIBUTE = "type";
	
	/** the value to the callback type attribute indicating that the URL it contains returns the status of a web service invocation */
	public static final String STATUS_CALLBACK_TYPE = "status";
	
	/** the value to the callback type attribute indicating the that URL it contains returns the result of a web service invocation */
	public static final String RESULT_CALLBACK_TYPE = "result";
	
	/** the value to the callback type attribute indicating that the URL it contains returns the currently pending feedback request of a web service invocation */
	public static final String FEEDBACK_SHOW_CALLBACK_TYPE = "feedbackShow";
	
	/** the value to the callback type attribute indicating that the URL it contains skips the currently pending feedback request of a web service invocation, and any subsequent ones */
	public static final String FEEDBACK_SKIP_CALLBACK_TYPE = "feedbackSkip";
	
	
	/** the invocation path suffix causing the web service servlet to return XML formatted descriptions of the web services it provides, to use with HTTP GET */
	public static final String LIST_FUNCTIONS_COMMAND = "listFunctions";
	
	/** the invocation path suffix causing the web service servlet to return XML formatted descriptions of the web service invocations of a given client (user or other) that follows in the invocation path right after this suffix, separated with a slash, to use with HTTP GET */
	public static final String LIST_REQUESTS_COMMAND = "listRequests";
	
	/** the invocation path suffix for invoking a web service, to be used with HTTP POST */
	public static final String INVOKE_FUNCTION_COMMAND = "invokeFunction";
	
	/** the invocation path suffix for interacting with the web service servlet on a running invocation, to be suffixed by the invocation ID and the desired action; if action is omitted, it defaults to 'status', to be used with HTTP GET */
	public static final String CALLBACK_COMMAND = "callback";
	
	/** the invocation path suffix for submitting the answer to a feedback request, to be used with HTTP POST */
	public static final String ANSWER_FEEDBACK_REQUEST_COMMAND = "answerFeedbackRequest";
	
	/** the suffix for the callback for obtaining the status of an invocation */
	public static final String STATUS_ACTION = "status";
	
	/** the suffix for the callback for obtaining the result of an invocation, soon as it becomes available */
	public static final String RESULT_ACTION = "result";
	
	/** the suffix for the callback for obtaining the currently pending feedback request of an invocation, if any */
	public static final String SHOW_FEEDBACK_REQUEST_ACTION = "showFeedbackRequest";
	
	/** the suffix for the callback for skipping the currently pending feedback request of an invocation, if any */
	...
	/** the HTTP parameter specifying the data format to use in the invocation of a web service and in obtaining an invocation result; defaults to the web service default settings if omitted */
	public static final String DATA_FORMAT_PARAMETER = "dataFormat";
	
	/** the HTTP parameter specifying the URL to obtain the to-process data from in the invocation of a web service; the data string is used if omitted */
	public static final String DATA_URL_PARAMETER = "dataUrl";
	
	/** the HTTP parameter specifying the data to process in the invocation of a web service; the data URL takes precedence if specified */
